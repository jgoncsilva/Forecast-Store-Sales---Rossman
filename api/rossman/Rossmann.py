...
class Rossmann(object):
    def __init__(self):
        ...
        self.competition_time_month_scaler = pickle.load(open('/home/jhonatas/Projects/Rossman/Forecast-Predict-Sales---Rossman/parameter/competition_time_month_scaler.pkl', 'rb'))
        self.promo_time_week_scaler        = pickle.load(open('/home/jhonatas/Projects/Rossman/Forecast-Predict-Sales---Rossman/parameter/promo_time_week_scaler.pkl', 'rb'))
        self.year_scaler                   =  pickle.load(open('/home/jhonatas/Projects/Rossman/Forecast-Predict-Sales---Rossman/parameter/year_scaler.pkl', 'rb'))
        self.store_type_scaler             = pickle.load(open('/home/jhonatas/Projects/Rossman/Forecast-Predict-Sales---Rossman/parameter/store_type_scaler.pkl', 'rb'))
